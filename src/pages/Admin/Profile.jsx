...
const ProfileAdmin = () => {
  ...
  return (
    <AdminLayout title="Informasi Profil">
        ...
        <div style={styles.card} className="profile-main-card">
          ...
          <div style={styles.profileContent} className="profile-inner">
            <div style={styles.leftSection}>
              ...
              <button style={styles.editBtn} onClick={() => navigate('/Admin/Profile/Edit')}>
            ...
            <div style={styles.rightSection}>
              ...
              <p style={{ margin: '0 0 30px 0', color: colors.textMuted, fontSize: '14px' }}>Admin Profesional IBNA Study</p>
              ...
              <div style={styles.infoGrid}>
                ...
                <div style={styles.infoCard}>
                  ...
                  <div>
                    ...
                    <p style={styles.value}>{userData?.role || 'Admin'}</p>
                  </div>
                </div>
              </div>
            </div>
